...
from models.llm_service import OpenAIVisionService
...
def create_gradio_interface(app):
    ...
    with gr.Blocks(theme=gr.themes.Soft(), title="Fashion Style Analyzer") as demo:
        ...
        with gr.Row():
            ...
            gr.Image(value="examples/fashion-image-1.jpg", label="Example 1", show_label=True, scale=1)
            gr.Image(value="examples/fashion-image-2.jpeg", label="Example 2", show_label=True, scale=1)
            gr.Image(value="examples/fashion-image-3.jpeg", label="Example 3", show_label=True, scale=1)
...
if __name__ == "__main__":
    try:
        ...
        app = StyleFinderApp("swift-style-embeddings.pkl") # Dataset of 192 images of taylor swift. That are embedded into vectors
