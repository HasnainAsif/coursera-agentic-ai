...
class MCPClient:
    ...
    async def connect(self, server_script: str):
        server_params = StdioServerParameters(
            command= "python", # sys.executable is /home/tk-lpt-648/miniconda3/envs/mcp_env/bin/python3.11, if we start client application using /home/tk-lpt-648/miniconda3/envs/mcp_env/bin/python3.11 mcp_client.py mcp_server.py
            args=[server_script],
            env=None
        )
