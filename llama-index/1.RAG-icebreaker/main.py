...
# process_linkedin(linkedin_url, api_key, mock): 
# This function serves as the core orchestrator of our application. 
# It should coordinate the entire RAG pipeline by first extracting LinkedIn profile data (either via API or from mock data), 
# then splitting this data into manageable nodes, creating a vector database from these nodes, 
# verifying that embeddings were properly created, 
# generating initial conversation starters about the person, 
# and finally launching the interactive chatbot interface. 
# This function handles the end-to-end workflow from raw LinkedIn URL to a fully functional conversational assistant.
...
# This function creates a user-friendly command-line interface for interacting with our bot. 
# It should display clear instructions to the user, 
# create a loop that processes user questions about the LinkedIn profile, 
# retrieve answers using our query engine, 
# display these answers in a conversational format, 
# and provide a clean exit mechanism.
