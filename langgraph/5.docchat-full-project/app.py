...
EXAMPLES = {
    "Google 2024 Environmental Report": {
        ...
        "file_paths": ["examples/google-2024-environmental-report.pdf"] # There is some issue on default filepath
    },
    "DeepSeek-R1 Technical Report": {
        "question": "Summarize DeepSeek-R1 model's performance evaluation on all coding tasks against OpenAI o1-mini model",
        "file_paths": ["examples/DeepSeek-Technical-Report.pdf"] # There is some issue on default filepath
    }
}
...
def main():
    ...
    demo.launch(server_name="127.0.0.1", theme=gr.themes.Citrus(), css=css, js=js)
