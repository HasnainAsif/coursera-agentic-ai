...
class VerificationAgent:
    def __init__(self):
        ...
        self.model = ChatOpenAI(model="gpt-4o-mini",model_kwargs={"max_completion_tokens": 300})
    ...
    def check(self, answer: str, documents: List[Document]) -> Dict:
        ...
        try:
            llm_response = response.content.strip() # Here we could also use llm with tools. Because, in bottom; we are manually parsing llm_response
